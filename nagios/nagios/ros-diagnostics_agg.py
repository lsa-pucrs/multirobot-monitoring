    ...
    while not ready:
        for current in data.status:
          ...
          if (options.name == "all" or options.name in current.name):
              ...
              #print "total_level - %s" % (total_level)
              #print "OK_sensors - %s" % (OK_sensors)
              #print "WARNING_sensors - %s" % (WARNING_sensors)
              #print "CRITICAL_sensors - %s" % (CRITICAL_sensors)
              #print "STALE_sensors - %s" % (STALE_sensors)
              #print "--------------------------------------------------------------------------"
